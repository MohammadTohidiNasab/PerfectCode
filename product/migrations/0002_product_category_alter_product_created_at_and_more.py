...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='updated_at',
            field=models.DateTimeField(auto_now=True, null=True, verbose_name='زمان به روز رسانی'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, null=True, verbose_name='ادرس الکترونیکی')),
                ('massage', models.TextField(null=True, verbose_name='متن نظر')),
                ('date', models.DateField(auto_now_add=True, null=True, verbose_name='تاریخ ثبت')),
